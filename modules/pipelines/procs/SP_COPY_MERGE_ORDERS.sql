  ...
  EXECUTE IMMEDIATE
    'MERGE INTO ' || v_tbl_fq || ' AS T
     ...
     WHEN NOT MATCHED THEN INSERT
         (ORDER_ID, AMOUNT, SRC_FILENAME, SRC_ROW_NUMBER, CREATED_AT, CREATED_BY, LOAD_ID)
       VALUES
         (S.ORDER_ID, S.AMOUNT, S.SRC_FILENAME, S.SRC_ROW_NUMBER, CURRENT_TIMESTAMP(), ''' || SPROC_NAME ||''', S.LOAD_ID)';
