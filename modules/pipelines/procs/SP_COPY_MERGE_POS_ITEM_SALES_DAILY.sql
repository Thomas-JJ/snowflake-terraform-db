...
BEGIN
    ...
    EXECUTE IMMEDIATE
        'COPY INTO STG_' || TARGET_TABLE || '
           FROM @STG_SALES_POSITEMSALESDAILY_' || ENV || '
           FILE_FORMAT = (FORMAT_NAME = ' || DB_NAME || '.' || SCHEMA_NAME || '.FF_SALES_POSITEMSALESDAILY_' || ENV || ')
           PATTERN = ''' || PATTERN || '''
    ...
    EXECUTE IMMEDIATE
        'MERGE INTO ' || TARGET_TABLE || ' AS T
         ...
         WHEN NOT MATCHED THEN INSERT (
           DATE, STORE_ID, ITEM_ID, SALES_AMT, SALES_QTY
         )
         VALUES (
           S.DATE, S.STORE_ID, S.ITEM_ID, S.SALES_AMT, S.SALES_QTY
         );';
